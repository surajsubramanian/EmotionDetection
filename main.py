...
parser.add_argument('-i', '--input', default='cut.mp4', help = 'Enter video name present in current directory')
args = parser.parse_args()
print("Video name :", args.input)

if args.input not in os.listdir(root):
    sys.exit(args.input, " not present in directory")
